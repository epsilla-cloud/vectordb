set(EPSILLA_THIRDPARTY_DEPENDENCIES

        Opentracing
        fiu
        oatpp)

message(STATUS "Using ${EPSILLA_DEPENDENCY_SOURCE} approach to find dependencies")

# For each dependency, set dependency source to global default, if unset
foreach (DEPENDENCY ${EPSILLA_THIRDPARTY_DEPENDENCIES})
    if ("${${DEPENDENCY}_SOURCE}" STREQUAL "")
        set(${DEPENDENCY}_SOURCE ${EPSILLA_DEPENDENCY_SOURCE})
    endif ()
endforeach ()

macro(build_dependency DEPENDENCY_NAME)
    if ("${DEPENDENCY_NAME}" STREQUAL "Opentracing")
        build_opentracing()
